...
Stage 1 runs before the LLM audit and produces signals based on vector maths rather than LLM inference. 
...
def compute_stage1_scores(
    ...
    The `all_code_labels` param is accepted for interface consistency but not used directly in this function.
    ...
    Args:
        ...
        all_code_labels: All code labels in the project.

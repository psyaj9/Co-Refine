"""Projects router: Endpoints for project management, settings, and membership.
...
Endpoints:
  ...
  GET    /{project_id}/settings         Get threshold settings
  PUT    /{project_id}/settings         Update settings
  GET    /{project_id}/members          List project members
  POST   /{project_id}/members          Invite a user by email
  DELETE /{project_id}/members/{uid}    Remove a coder
"""
...
def invite_member(
    ...
    # Collaborators join as "coder" by default
...
def remove_member(
    ...
    """Remove a coder from the project"""
    project = get_project_by_id(db, project_id)

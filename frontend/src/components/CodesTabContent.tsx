...
import { COLOUR_PALETTE, getNextColour } from "@/lib/constants";
...
export default function CodesTabContent() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden tab-content-enter">
      ...
      {/* Code list */}
      <ul className="flex-1 overflow-auto px-2 pb-2 thin-scrollbar space-y-0.5" role="list" aria-label="Codebook">
